(() => {
  const copy = {
    ru: {
      ...
      date: 'СТАРТ 28 СЕНТЯБРЯ', course: 'Мастер-класс по созданию нейро-контента с телефона',
      ...
      description: 'НЕЙРОМОБИЛЬ: мастер-класс по созданию нейро-контента с телефона, контент на заказ и портфолио. Старт мастер-класса — 28 сентября.'
    },
    en: {
      ...
      date: 'STARTS SEPTEMBER 28', course: 'Masterclass: create AI content on your phone',
      courseDescription: '10 days. Just your phone. Lifetime access. Tap to sign up.',
      notice: 'The masterclass is in Russian for now. We’re preparing a guide in English — announcement coming soon!',
    ...
    es: {
      ...
      date: 'INICIO: 28 DE SEPTIEMBRE', course: 'Clase magistral: crea contenido con IA desde tu móvil',
      courseDescription: '10 días. Solo tu móvil. Acceso de por vida. Pulsa para inscribirte.',
      notice: 'Por ahora, la clase magistral se imparte en ruso. Estamos preparando una guía en inglés. ¡La anunciaremos pronto!',
